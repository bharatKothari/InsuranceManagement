...
@WebServlet("/agent/addPayment")
public class AgentAddPayment extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public AgentAddPayment() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session==null || session.getAttribute("agentID")==null) {
			...
			response.sendRedirect(request.getContextPath()+"/agent-dashboard/examples/payment.jsp");
		}
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect(request.getContextPath()+"/agent/checkDues");
